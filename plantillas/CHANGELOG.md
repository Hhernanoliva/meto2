...
*(Escribir este archivo en el idioma humano del proyecto, declarado en `CLAUDE.md`.)*
...
> disparador, y está escrito en `CLAUDE.md`. El archivo existe vacío a propósito
